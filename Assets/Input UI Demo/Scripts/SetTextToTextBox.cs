...
public class SetTextToTextBox : MonoBehaviour
{
    ...
    {   // to make sure we are not picking a device, we do not have a sprite asset for
    ...
    { 
        // Temporary, to be replaced with logic that detects which device type is submitting input.
        Keyboard = 0,
        Gamepad = 1    
    }
